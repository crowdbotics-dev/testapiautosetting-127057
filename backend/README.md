...
## Project Structure
    ...
    ├── testapiautosetting_127057  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127057`
...
2. Clone this repo and `cd testapiautosetting_127057`
